...
export const success = (message = 'Action successful') => toast.custom((t) => (
    <div
        className={cn(t.visible ? 'animate-enter' : 'animate-leave', 'max-w-md w-full bg-white shadow-lg rounded-lg pointer-events-auto flex border border-[#e4e5e6]')}
    >
        ...
        <div className="relative">
            <button
                ...
                className="w-[18px] h-[18px] absolute top-[-7px] left-[-10px] grid place-items-center rounded-full bg-white border border-[#e4e5e6]"
            >
