...
export default function ExamQuizResult({ loaderData }) {
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid place-items-center text-center mb-10">
                        ...
                        <div className="flex items-center gap-2 mt-2">
                            <span className="text-sm text-gray-600 leading-[1.5]">Exam mode</span>
                            <span className="text-primary">•</span>
                            <div className="flex items-center text-sm text-gray-600 leading-[1.5]">
