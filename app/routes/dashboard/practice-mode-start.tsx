        ...
        <div className="min-h-screen bg-background grid place-items-center">
            <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
                <div className="text-center">
                    ...
                    <p className="text-muted-foreground my-8">Let’s go! Once you start, the practice session will begin immediately and can’t be paused. Are you sure you’re ready to dive in?</p>
                </div>

                <div className="flex sm:items-center gap-2 sm:gap-4 justify-between">
                    <Button
                        variant="outline"
                        onClick={handleExit}
